"""Toth - Dual Site Langmuir isotherm model."""
...
class TothDSLangmuir(IsothermBaseModel):
    r"""
    Toth - Dual Site Langmuir isotherm model.
    ...
    .. math::
        ...
        n_{m_2}\frac{K_2 p}{1+K_2 p} +
        n_{m_3}\frac{K_3 p}{1+K_3 p}

    Notes
    -----
    An extension to the Toth and Langmuir model to consider three adsorption
    sites, with different monolayer capacities, affinities, and exponents.  The
    final two sites have an exponent of 1, i.e. is a Langmuir site. This
    is based on the ChemiPhysisorption model proposed by Low et al.[#]_, but with
    one chemisorption and two physisorption sites. This has
