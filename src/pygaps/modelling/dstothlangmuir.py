"""Dual Site Toth - Langmuir isotherm model."""
...
class DSTothLangmuir(IsothermBaseModel):
    r"""
    Dual Site Toth - Langmuir isotherm model.
    ...
    final site has an exponent of 1, i.e. is a Langmuir site. This
    is based on the ChemiPhysisorption model proposed by Low et al.[#]_, but with
    two chemisorption and one physisorption sites. This has
